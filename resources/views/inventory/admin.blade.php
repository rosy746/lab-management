...
.btn-sm-edit { background:#f0f9f4;color:#166534;border:1.5px solid #bbf7d0;border-radius:7px;padding:5px 11px;font-size:11px;font-weight:700;cursor:pointer;font-family:inherit; }
.btn-sm-del  { background:#fff;color:#9ca3af;border:1.5px solid #f3f4f6;border-radius:7px;padding:5px 9px;font-size:11px;cursor:pointer; }
...
<div style="background:#fff;border-radius:14px;padding:14px 18px;border:1px solid #e8f0e6;margin-bottom:16px;display:flex;flex-wrap:wrap;gap:10px;align-items:center">
    <form method="GET" action="{{ route('inventory.admin') }}" style="display:flex;flex-wrap:wrap;gap:10px;flex:1;align-items:center">
        <input type="text" name="search" value="{{ request('search') }}" placeholder="🔍 Cari nama, merk, spesifikasi..." class="filter-inp" style="flex:1;min-width:160px">
            ...
            <tbody>
                ...
                <tr style="border-top:1px solid #f5f5f5;transition:background .1s" onmouseover="this.style.background='#fafcf9'" onmouseout="this.style.background=''">
                    <td style="padding:12px 16px">
                        ...
                        <div style="font-size:11px;color:#9ca3af;margin-top:2px;max-width:200px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">{{ $item->specifications }}</div>
                        @endif
                    </td>
                    <td style="padding:12px 16px">
        ...
        <form method="POST" action="{{ route('inventory.admin.store') }}" class="modal-body">
            ...
            <div class="form-row" style="grid-template-columns:repeat(4,1fr)">
                <div>
                    ...
                    <input type="number" name="quantity" class="inp" value="1" min="0" required>
                </div>
                <div>
                    <label class="form-label">Baik</label>
                    <input type="number" name="quantity_good" class="inp" value="1" min="0" required>
                </div>
                <div>
                    <label class="form-label">Rusak</label>
                    <input type="number" name="quantity_broken" class="inp" value="0" min="0" required>
                </div>
                <div>
...
<div id="edit-modal" class="modal-overlay" onclick="if(event.target===this)closeEdit()">
    <div class="modal-box">
        ...
        <form id="edit-form" method="POST" class="modal-body">
            ...
            <div class="form-row" style="grid-template-columns:repeat(4,1fr)">
                <div><label class="form-label">Total</label><input type="number" name="quantity" id="e-qty" class="inp" min="0" required></div>
                <div><label class="form-label">Baik</label><input type="number" name="quantity_good" id="e-good" class="inp" min="0" required></div>
