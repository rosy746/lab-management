...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $required_fields = ['resource_id', 'item_name', 'category', 'condition', 'status', 'quantity'];
        $errors = [];
        ...
        if (!empty($errors)) {
            ...
            if (!$resource_check->fetch()) {
                ...
                if ($result) {
                    $success_message = "Inventaris berhasil ditambahkan: " . htmlspecialchars($_POST['item_name']);
      ...
      <div class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group full">
            ...
            <input type="text" name="item_name" placeholder="PC Unit 1 / Monitor LG / Keyboard Logitech" 
      ...
      <div class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group">
            ...
            <input type="text" name="brand" placeholder="ASUS / Logitech / HP" 
                   value="<?= htmlspecialchars($_POST['brand'] ?? '') ?>" maxlength="100">
          </div>

          <div class="form-group">
            <label>Model/Tipe</label>
            <input type="text" name="model" placeholder="VivoPC / G102 / EliteDesk" 
                   value="<?= htmlspecialchars($_POST['model'] ?? '') ?>" maxlength="100">
          </div>

          <div class="form-group full">
            <label>Serial Number</label>
            <input type="text" name="serial_number" placeholder="SN-123456789" 
